...
const ALL_QUESTIONS = [
    ...
    },
    {
        id: 3,
        type: 'map',
        question: 'סמנו על המפה: איפה נמצא בית הכנסת העתיק ביותר שהתגלה בארץ? (גמלא)',
        correctRegion: 'galilee',
        explanation: 'בית הכנסת בגמלא נבנה במאה ה-1 לפנה"ס והוא נחשב לבית הכנסת העתיק ביותר שנמצא בארץ ישראל. גמלא נמצאת ברמת הגולן.',
